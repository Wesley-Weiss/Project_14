...
import {addDecimal, addOperators, addValues, backspace, clear, evaluate, updateTypingStatus} from './actions';
          ...
          <div className="left-side">
            <div className="numbers">
              {Object.keys(keypadBtns.numbers).map((num, index) => (
                <div className="btn" key={index} id={num} onClick={() => {
            ...
            <div className="operators">
              {Object.keys(keypadBtns.operators).map((name, index) => (
                <div className="btn" key={index} id={name} onClick={() => {
                  if (name != "subtract") {
